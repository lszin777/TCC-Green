            ...
            <div className="dark:bg-[rgba(38,64,22,1)]">
                ...
                <main className="flex bg-center px-12  flex justify-between items-start pt-12 gap-30  pb-25">
                    <div>
                        ...
                        <p className="pt-15 font-semibold text-[15px] text-center dark:text-white">Modelagem da biomassa de plantações florestais a partir da tecnologia LiDAR embarcada em drone</p>
                    </div>
                    <div>
                        <img src={foto2} alt=""  className="h-60 rounded-3xl" />
                        <p className="pt-15 font-semibold text-[15px] text-center dark:text-white">Tecnologia de fertilizantes agrícolas impacta na produtividade e durabilidade da plantação</p>
                    </div>
                    <div>
                        <img src={foto3} alt=""  className="h-60 rounded-3xl" />
                        <p className="pt-15 font-semibold text-[15px] text-center dark:text-white">Planejamento de um sistema de monitoramento de plantações para aplicação na agricultura familiar</p>
                    </div>
                    <div>

...
export function Jogo() {
  return (
    <div className=" min-h-screen flex flex-col">
      {/* Título */}
      <main className="flex flex-col items-center bg-white rounded-t-2xl -mt-5 p-8">
        <h1 className="text-3xl font-bold text-green-900 mb-6">Jogo</h1>

        {/* Seção Como Jogar */}
        <section className="grid md:grid-cols-2 gap-10 max-w-5xl w-full">
          {/* Imagem do jogo */}
          ...
          <div className="text-gray-700 flex flex-col justify-center">
            <h2 className="text-lg font-bold mb-4">Como Jogar</h2>
            <p className="mb-4">
